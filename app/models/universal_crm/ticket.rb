module UniversalCrm
  class Ticket
    ...
    include HmsCore::Concerns::Polymorphic #the customer (subject)
    ...
    field :vids, as: :viewer_ids, type: Array, default: [] #an array of users who are viewing this ticket
    field :eids, as: :editor_ids, type: Array, default: [] #an array of users who are editing this ticket (replying)
    ...
    belongs_to :creator, class_name: 'Padlock::User', foreign_key: :creator_id
    belongs_to :responsible, class_name: 'Padlock::User', foreign_key: :responsible_id
    ...
    def viewers
      Padlock::User.in(id: self.viewer_ids)
    end

    def editors
      Padlock::User.in(id: self.editor_ids)
    end
